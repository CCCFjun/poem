...
public class StudentWrongController {
    ...
    */
    ...
    public ServerResponse getPapersInfoByWrongPaperId(@RequestParam("userPhone")String userPhone,
        ...
        List<Map<String, Object>> singleQueList = studentWrongService.getSingleQueListByWrongPaperId(userPhone, paperId);
//        List<Map<String, Object>> multipleQueList = studentWrongService.getMultipleQueListByWrongPaperId(userPhone, paperId);
        List<Map<String, Object>> judgeQueList = studentWrongService.getJudgeQueListByWrongPaperId(userPhone, paperId);
        List<Map<String, Object>> fillQueList = studentWrongService.getFillQueListByWrongPaperId(userPhone, paperId);
        List<Map<String, Object>> fillTwoQueList = studentWrongService.getFillTwoQueListByWrongPaperId(userPhone, paperId);
...
//            map.put("multipleQueList",multipleQueList);
    ...
    */
    ...
    public ServerResponse getAllCollections(@RequestParam("userPhone")String userPhone){
        List<Map<String, Object>> resultList = studentWrongService.getAllCollections(userPhone);
