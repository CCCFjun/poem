...
//            log.info(""+resultList);
    ...
    public ServerResponse getCurrentPaperStatus(@RequestBody(required = false)StudentPaperScore studentPaperScore){
        ...
        List<StudentPaperScore> resultList = studentHomeService.getCurrentPaperStatus(userPhone, paperId);
        if(resultList != null && resultList.size() > 0){
...
//        List<Map<String, Object>> multipleQueList = studentHomeService.getMultipleQueListByPaperId(paperId);
        ...
        List<Map<String, Object>> fillTwoQueList = studentHomeService.getFillTwoQueListByPaperId(paperId);
...
//    }
    ...
    public ServerResponse submitPaper(@RequestBody Map<String, Object> obj){
        ...
        int result = studentHomeService.insertPaperAnswerAndPaperScore(userPhone, paperId, singleAnswers,
    ...
    public ServerResponse getScoreListByPaperId(@RequestParam("paperId")Integer paperId){
        List<Map<String, Object>> resultList = studentHomeService.getScoreListByPaperId(paperId);
        if(resultList != null && resultList.size() > 0){
